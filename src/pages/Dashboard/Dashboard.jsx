...
// const featureCards = [
//   { title: 'Upload Banners', path: '/upload-banner', icon: <CloudUploadIcon sx={{ fontSize: 40 }}/>, description: 'Add new individual banners to the system.' },
//   { title: 'Banner List', path: '/banner-list', icon: <ViewListIcon sx={{ fontSize: 40 }}/>, description: 'View, edit, and manage all existing banners.' },
//   { title: 'Bulk Upload', path: '/bulk-upload', icon: <BackupTableIcon sx={{ fontSize: 40 }}/>, description: 'Upload multiple banners at once using a CSV file.' },
// ];
